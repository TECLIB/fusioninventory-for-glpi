 ...
 * @since 9.3+1.0
 */
class PluginFusioninventoryImportDeviceProcessor extends PluginFusioninventoryImportDevice {

   //Store the inventory to be processed
   protected $a_inventory = [];

   //The itemtype of the device we're processing
   protected $device_itemtype = 'DeviceProcessor';

   //Store the key related to the
   protected $section = 'processor';

   function getQuery() {
      return "SELECT `glpi_items_deviceprocessors`.`id`, `designation`,
