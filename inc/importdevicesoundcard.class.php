 ...
 * @since 9.3+1.0
 */
class PluginFusioninventoryImportDeviceSoundCard extends PluginFusioninventoryImportDevice {

   //Store the inventory to be processed
   protected $a_inventory = [];

   //The itemtype of the device we're processing
   protected $device_itemtype = 'DeviceSoundcard';

   //Store the key related to the
   protected $section = 'soundcard';

   function getQuery() {
      return "SELECT `glpi_items_devicesoundcards`.`id`, `designation`, `comment`,
