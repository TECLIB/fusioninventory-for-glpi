 ...
 * @since 9.3+1.0
 */
class PluginFusioninventoryImportDeviceControl extends PluginFusioninventoryImportDevice {

   //Store the inventory to be processed
   protected $a_inventory = [];

   //The itemtype of the device we're processing
   protected $device_itemtype = 'DeviceControl';

   //Store the key related to the
   protected $section = 'controller';

   function getQuery() {
      return "SELECT `glpi_items_devicecontrols`.`id`, `interfacetypes_id`,
