 ...
 * @since 9.3+1.0
 */
class PluginFusioninventoryImportDeviceGraphicCard extends PluginFusioninventoryImportDevice {

   //Store the inventory to be processed
   protected $a_inventory = [];

   //The itemtype of the device we're processing
   protected $device_itemtype = 'DeviceGraphicCard';

   //Store the key related to the
   protected $section = 'graphiccard';

   function getQuery() {
      return "SELECT `glpi_items_devicegraphiccards`.`id`, `designation`, `memory`
