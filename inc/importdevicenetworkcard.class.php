 ...
 * @since 9.3+1.0
 */
class PluginFusioninventoryImportDeviceNetworkCard extends PluginFusioninventoryImportDevice {

   //Store the inventory to be processed
   protected $a_inventory = [];

   //The itemtype of the device we're processing
   protected $device_itemtype = 'DeviceNetworkCard';

   //Store the key related to the
   protected $section = 'networkcard';

   function getQuery() {
      return "SELECT `glpi_items_devicenetworkcards`.`id`, `designation`, `mac`,
               `manufacturers_id`
